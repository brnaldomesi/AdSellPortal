                                            ...
                                            <div class="well pb-0">
                                                ...
                                                <div class="form-group mb-0">
                                                    <table id="packagesTable" class="table table-hover checkboxtable mb-0">
                                                        ...
                                                        <p>
                                                        <!-- XLABS Code Product Addons-->
                                                        <h3><i class="icon-certificate icon-color-1"></i> Additional Services </h3>
                                                <p>
                                                    {{ t('The premium package help sellers to promote their products or services by giving more visibility to their ads to attract more buyers and sell faster.') }}
                                                </p></p>
																	...
																	<div class="form-check">
                                                                        ...
                                                                        <label class="form-check-label mb-0{{ $packageIdError }}">
                                                                            <strong class="tooltipHere"
																					...
																					data-placement="right"
																					data-toggle="tooltip"
																					data-original-title="Secertery Service"
																			> Secertery Service </strong>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td class="text-right align-middle p-3">
																	...
																	<div class="form-check">
                                                                        ...
                                                                        <label class="form-check-label mb-0{{ $packageIdError }}">
                                                                            <strong class="tooltipHere"
																					...
																					data-placement="right"
																					data-toggle="tooltip"
																					data-original-title="Noterion service"
																			> Noterion service </strong>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td class="text-right align-middle p-3">
																	...
																	<div class="form-check">
                                                                        ...
                                                                        <label class="form-check-label mb-0{{ $packageIdError }}">
                                                                            <strong class="tooltipHere"
																					...
																					data-placement="right"
																					data-toggle="tooltip"
																					data-original-title="Energy Certificate"
																	...
																	<div class="form-check">
                                                                        ...
                                                                        <label class="form-check-label mb-0{{ $packageIdError }}">
                                                                            <strong class="tooltipHere"
																					...
																					data-placement="right"
																					data-toggle="tooltip"
																					data-original-title="Get Expert Opinion"
																			> Get Expert Opinion</strong>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td class="text-right align-middle p-3">
