                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group row required">
                                            ...
                                            <div class="{{ $descriptionColClass }}">
                                                ...
                                                <small id=""
                                                       class="form-text text-muted">{{ t('Describe what makes your ad unique') }}</small>
                                            </div>
                                        </div>
                                            ...
                                            <div class="input-group col-md-8">
                                                <div class="input-group-prepend">
                                                    <span id="phoneCountry"
                                                          class="input-group-text">{!! getPhoneIcon($post->country_code) !!}</span>
                                                </div>
                                        ...
                                        <div class="form-group row required">
                                            ...
                                            <div class="col-md-8">
                                                <input id="address_street" name="address_street"
                                                       ...
                                                       value="{{ old('address_street', $post->street_name) }}">
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <input id="address_house_no" name="address_house_no"
                                                               ...
                                                               type="text"
                                                               value="{{ old('address_house_no', $post->house_number) }}">
                                                    </div>
                                                    <div class="col-md-1">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input id="orientational_number" name="orientational_number"
                                                               ...
                                                               type="text"
                                                               value="{{ old('orientational_number', $post->orientational_number) }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row required">
                                            ...
                                            <div class="col-md-8">
                                                <input id="address_town_name" name="address_town_name"
                                                       ...
                                                       value="{{ old('address_town_name', $post->town_name) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row required">
                                            ...
                                            <div class="col-md-8">
                                                <input id="address_town_district" name="address_town_district"
                                                       ...
                                                       value="{{ old('address_town_district', $post->town_district) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row required">
                                            ...
                                            <div class="col-md-8">
                                                <input id="address_zip_code" name="address_zip_code"
                                                       ...
                                                       value="{{ old('address_zip_code',$post->zip_code) }}">
                                            </div>
                                        </div>
