...
return [
    ...
    'whitelist_email' => 'ที่อยู่อีเมลถูกแบล็คลิสต์',
    'whitelist_domain' => 'โดเมนที่อยู่อีเมลของคุณถูกแบลคลิสต์',
    'whitelist_word' => ':attribute มีคำหรือวลีที่ไม่เหมาะสม',
    'whitelist_word_title' => ':attribute มีคำหรือวลีที่ไม่ถูกต้อง',
    'mb_between' => ':attribute ต้องมีอักขระอยู่ในระหว่าง :min และ :max ตัว',
    ...
    'valid_username' => 'ฟิลด์ :attribute  ต้องเป็นสตริงตัวเลขและตัวอักษร',
    'allowed_username' => ':attribute ถูกปฏิเสธ',
    'custom' => [
        'mysql_connection' => [
