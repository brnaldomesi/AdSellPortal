  ...
  $.ajax({
    ...
    if (data.status == 1) {
      if ($(elmt).hasClass("btn")) {
        ...
        $(elmt).html(
          '<i class="fa fa-heart tooltipHere" data-toggle="tooltip" data-original-title="' +
            lang.labelSavePostRemove +
            '"></i>'
        );
      }
      ...
      if ($(elmt).hasClass("btn")) {
        ...
        $(elmt).html(
          '<i class="far fa-heart tooltipHere" data-toggle="tooltip" data-original-title="' +
            lang.labelSavePostSave +
            '"></i>'
        );
      }
